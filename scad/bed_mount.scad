...
module mount_holes()
{
    ...
    //m3 screw
    translate([0,mount_gap,0])cylinder(r=m3_slot/2,h=50,$fn=12,center=true);
    //hex trap
    translate([0,mount_gap,-25])cylinder(r=m3nut_r,h=50,$fn=6,center=true);
}
...
module bracket()
{
    y_l=mount_gap+inside_wall_thick+m3_slot/2;
    hull()
    {
